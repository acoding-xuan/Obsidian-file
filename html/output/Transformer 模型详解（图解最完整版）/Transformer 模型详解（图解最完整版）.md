...
![](<assets/1713257995028.png>)

## 5. Decoder 结构

![](<assets/1713257995085.png>)
...
**第三步：**在得到 $QK^{T}$QK^{T} 之后需要进行 Softmax，计算 attention score，我们在 Softmax 之前需要使用 **Mask** 矩阵遮挡住每一个单词之后的信息，遮挡操作如下：
